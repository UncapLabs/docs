...
![Borrow USDU](/img/Borrow-USDU.gif)

- [Open a collateralised debt position](https://uncap.finance/borrow) by depositing your BTC to mint USDU.
...
![Earn Yield](/img/Earn_yield.gif)

- [Deposit your newly minted USDU](https://uncap.finance/earn) into the Stability Pool to help secure the protocol.
...
![LP Ekubo](/img/LP%20Ekubo.gif)

- You can also use your assets to [provide liquidity for the USDU/USDC pair](https://app.ekubo.org/positions/new?baseCurrency=USDU&quoteCurrency=USDC&tickLower=-27641100&tickUpper=-27621100) on the Ekubo exchange.
- This helps support USDU's liquidity while allowing you to earn swap fees.

## Start doing more with your Bitcoin

Visit [uncap.finance](https://uncap.finance/) to get started today and unlock the full potential of your Bitcoin.
